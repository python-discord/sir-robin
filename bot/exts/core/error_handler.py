...
from bot.constants import (ERROR_REPLIES, NEGATIVE_REPLIES, Channels, Colours,
                           RedirectOutput)
from bot.utils.exceptions import (InIntervalCheckFailure, MovedCommandError,
                                  UserNotPlayingError)
...
class CommandErrorHandler(commands.Cog):
    ...
    async def on_command_error(self, ctx: commands.Context, error: commands.CommandError) -> None:
        ...
        if isinstance(error, commands.CommandNotFound):
            ...
            return
        if isinstance(error, InIntervalCheckFailure):
