...
class HelpQueryNotFoundError(ValueError):
    ...
    def __init__(
            self, arg: str, *, parent_command: Command | None = None
    ) -> None:
        super().__init__(arg)
...
class HelpSession:
    ...
    def _handle_not_found(self, query: str) -> None:
        ...
        raise HelpQueryNotFoundError(f'Query "{query}" not found.')
...
def teardown(bot: SirRobin) -> None:
    """
